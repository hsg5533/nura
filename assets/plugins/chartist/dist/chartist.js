(function (root, factory) {
  ...
  (function (window, document, Chartist) {
    ...
    Chartist.getAvailableHeight = function (svg, options) {
      return Math.max(
        (Chartist.stripUnit(options.height) || svg.height()) -
      ...
      Object.keys(attributes).forEach(
        function (key) {
          ...
          if (ns) {
            this._node.setAttributeNS(
              ns,
              [Chartist.xmlNs.prefix, ":", key].join(""),
              attributes[key]
            );
          } else {
        ...
        function (series, seriesIndex) {
          ...
          data.normalized[seriesIndex].forEach(
            function (value, valueIndex) {
              ...
              positions[labelAxis.counterUnits.pos + "1"] = options.stackBars
                ? previousStack
                : zeroPoint;
        ...
        if (options.showLabel) {
          ...
          var labelPosition = Chartist.polarToCartesian(
            ...
            interpolatedValue = options.labelInterpolationFnc(
              this.data.labels ? this.data.labels[i] : dataArray[i],
              i
            );

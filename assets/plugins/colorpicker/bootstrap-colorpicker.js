          ...
          _createClass(Palette, [
            ...
            },
            {
              ...
              value: function resolveColor(color) {
                ...
                return this.getName(
                  color,
                  this.getName("#" + color, this.getValue(color, false))
                );
              },
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Colorpicker = (function () {
          ...
          function Colorpicker(element, options) {
            ...
            $picker.appendTo(
              this.container ? this.container : (0, _jquery2.default)("body")
            );
          ...
          _createClass(Colorpicker, [
            {
              ...
              value: function addExtension(extensionName, ExtensionClass) {
                ...
                var ext =
                  extensionName instanceof _Extension2.default
                    ? extensionName
            ...
            },
            {
              ...
              value: function _reposition(e) {
                ...
                if (this.options.align === "right") {
                  offset.left -=
                    this.picker.outerWidth() - element.outerWidth();
                }
                this.picker.css({
            ...
            },
            {
              ...
              value: function show(e) {
                ...
                (0, _jquery2.default)(window).on(
                  "resize.colorpicker",
                  _jquery2.default.proxy(this._reposition, this)
                );
            ...
            },
            {
              ...
              value: function hide(e) {
                ...
                if (typeof e !== "undefined" && e.target) {
                  ...
                  if (
                    (0, _jquery2.default)(e.currentTarget).parents(
                      ".colorpicker"
                    ).length > 0 ||
                    (0, _jquery2.default)(e.target).parents(".colorpicker")
                      .length > 0
                  ) {
                    return false;
                  }
            ...
            },
            {
              ...
              value: function _updatePicker() {
                ...
                if (hueGuide.length) {
                  hueGuide.css(
                    vertical ? "top" : "left",
                    (vertical ? sl.hue.maxTop : sl.hue.maxLeft) * (1 - hsva.h)
                  );
                }
                ...
                if (alphaGuide.length) {
                  alphaGuide.css(
                    vertical ? "top" : "left",
                    (vertical ? sl.alpha.maxTop : sl.alpha.maxLeft) *
                      (1 - hsva.a)
                  );
                }
            ...
            },
            {
              ...
              value: function createColor(val) {
                ...
                var color = new _Color2.default(this._resolveColor(val), {
                  format: this.format,
                });
                ...
                if (!color.isValid()) {
                  ...
                  if (useFallback) {
                    fallback =
                      this.fallbackColor instanceof _Color2.default &&
              ...
              value: function _mousedown(e) {
                ...
                if (!zone.is(".colorpicker")) {
                  ...
                  this.currentSlider.guide =
                    zone.find(".colorpicker-guide")[0].style;
                   ...
                   * @event mousemove
                   */
                  (0, _jquery2.default)(window.document)
                    .on({
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Color = (function (_tinycolor) {
          ...
          function Color(color) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Color.__proto__ || Object.getPrototypeOf(Color)).call(
                this,
                unwrapColor(color),
                options
              )
          ...
          _createClass(Color, [
            ...
            },
            {
              ...
              value: function getHueOnlyCopy() {
                return new Color(
                  { h: this._hbak ? this._hbak : this.hsva.h, s: 100, v: 100 },
                  this.options
                );
              },
                  ...
                  $swatch.on(
                    ...
                    function (e) {
                      ...
                      colorpicker.setValue(
                        isAliased
                          ? (0, _jquery2.default)(this).data("name")

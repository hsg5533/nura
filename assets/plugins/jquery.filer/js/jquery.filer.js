  ...
  $.fn.filer = function (q) {
    return this.each(function (t, r) {
      var s = $(r),
        ...
        n =
          n_f && $.isPlainObject(n_f)
            ? $.extend(true, {}, $.fn.filer.defaults, n_f)
            : $.fn.filer.defaults,
        f = {
          init: function () {
          ...
          _changeInput: function () {
            ...
            n.beforeRender != null && typeof n.beforeRender == "function"
              ? n.beforeRender(p, s)
              : null;
            if (n.theme) {
            ...
            if (
              s.get(0).tagName.toLowerCase() != "input" &&
              s.get(0).type != "file"
            ) {
              o = s;
            ...
            n.afterRender != null && typeof n.afterRender == "function"
          ...
          _clear: function () {
            ...
            f._set(
              "feedback",
              f._itFl && f._itFl.length > 0
                ? f._itFl.length + " " + n.captions.feedback2
                : n.captions.feedback
            );
            n.onEmpty != null && typeof n.onEmpty == "function"
              ? n.onEmpty(p, o, s)
              : null;
          },
          _reset: function (a) {
          ...
          _thumbCreator: {
            create: function (i) {
              ...
              html = $(f._thumbCreator.renderContent(opts)).attr(
                "data-jfiler-index",
                id
              );
              ...
              html
                .hide()
                [n.templates.itemAppendToEnd ? "appendTo" : "prependTo"](
                  l.find(n.templates._selectors.list)
                )
                .show();
              if (!file._appended) {
                f._onSelect(i);
            ...
            renderContent: function (opts) {
              return f._assets.textParse(
                opts._appended ? n.templates.itemAppend : n.templates.item,
                opts
              );
            },
            ...
            generateIcon: function (obj) {
              ...
              if (obj && obj.type && obj.extension) {
                ...
                m[0] = "f-file";
                m[1] =
                  obj.extension && obj.extension.length > 0
                    ? "." + obj.extension
                    : "";
                m[2] = 1;
              }
            ...
            _box: function (params) {
              if (
                n.beforeShow != null && typeof n.beforeShow == "function"
                  ? !n.beforeShow(f.files, l, p, o, s)
                  : false
              ) {
                return false;
              }
              if (l.length < 1) {
                ...
                s.prop("jFiler").listEl = l;
                l.append(f._assets.textParse(n.templates.box)).appendTo(
                  appendTo
                );
                l.on("click", n.templates._selectors.remove, function (e) {
                  e.preventDefault();
                  var cf = n.templates.removeConfirmation
                    ? confirm(n.captions.removeConfirmation)
                    : true;
                  if (cf) {
                    f._remove(
                      params ? params.remove.event : e,
                      params
                        ? params.remove.el
                        : $(this).closest(n.templates._selectors.item)
                    );
                  }
                });
              }
          ...
          _upload: function (i) {
            ...
            formData.append(
              s.attr("name"),
              f._itFc.file,
              f._itFc.file.name ? f._itFc.file.name : false
            );
            if (
              n.uploadFile.data != null &&
              $.isPlainObject(n.uploadFile.data)
            ) {
          ...
          _ajax: {
              ...
              c.ajax = $.ajax({
                ...
                complete: function (jqXHR, textStatus) {
                  ...
                  if (f._ajFc >= f.files.length) {
                    f._ajFc = 0;
                    n.uploadFile.onComplete != null &&
                    typeof n.uploadFile.onComplete == "function"
                      ? n.uploadFile.onComplete(l, p, o, s, jqXHR, textStatus)
                      : null;
                  }
                },
                beforeSend: function (jqXHR, settings) {
                  return n.uploadFile.beforeSend != null &&
                    typeof n.uploadFile.beforeSend == "function"
                    ? n.uploadFile.beforeSend(
                        el,
                        l,
                        p,
                        o,
                ...
                success: function (data, textStatus, jqXHR) {
                  c.uploaded = true;
                  n.uploadFile.success != null &&
                  typeof n.uploadFile.success == "function"
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                  c.uploaded = false;
                  n.uploadFile.error != null &&
                  typeof n.uploadFile.error == "function"
                    ? n.uploadFile.error(
                        el,
                        l,
                        p,
            ...
            progressHandling: function (e, el) {
              if (e.lengthComputable) {
                ...
                n.uploadFile.onProgress != null &&
                typeof n.uploadFile.onProgress == "function"
                  ? n.uploadFile.onProgress(t, el, l, p, o, s)
                  : null;
          ...
          _dragDrop: {
            dragEnter: function (e) {
              ...
              n.dragDrop.dragEnter != null &&
              typeof n.dragDrop.dragEnter == "function"
                ? n.dragDrop.dragEnter(e, o, s, p)
                : null;
            },
            dragLeave: function (e) {
              ...
              n.dragDrop.dragLeave != null &&
              typeof n.dragDrop.dragLeave == "function"
                ? n.dragDrop.dragLeave(e, o, s, p)
                : null;
            },
            drop: function (e) {
              e.preventDefault();
              ...
              n.dragDrop.drop != null && typeof n.dragDrop.drop == "function"
                ? n.dragDrop.drop(
                    e.originalEvent.dataTransfer.files,
                    e,
                    o,
          ...
          _onSelect: function (i) {
            ...
            n.onSelect != null && typeof n.onSelect == "function"
              ? n.onSelect(f.files[i], f._itFc.html, l, p, o, s)
              : null;
            if (i + 1 >= f.files.length) {
              n.afterShow != null && typeof n.afterShow == "function"
                ? n.afterShow(l, p, o, s)
                : null;
            }
          },
          _onChange: function (e, d) {
            if (!d) {
              if (
                !s.get(0).files ||
                typeof s.get(0).files == "undefined" ||
                s.get(0).files.length == 0
              ) {
                if (!n.uploadFile && !n.addMore) {
                  f._set("input", "");
                  f._clear();
            ...
            if (
              !f._filesCheck() ||
              (n.beforeSelect != null && typeof n.beforeSelect == "function"
                ? !n.beforeSelect(f.files, l, p, o, s)
                : false)
            ) {
              f._set("input", "");
              f._clear();
            ...
            f._set(
              "feedback",
              f.files.length + f._itFl.length + " " + n.captions.feedback2
            );
            if (n.showThumbs) {
          ...
          _retryUpload: function (e, data) {
            var id = parseInt(
                typeof data == "object" ? data.attr("data-jfiler-index") : data
              ),
          ...
          _remove: function (e, el) {
                    ...
                    '<input type="hidden" name="jfiler-items-exclude-' +
                      (n.excludeName
                        ...
                        : (s.attr("name").slice(-2) != "[]"
                            ...
                            : s
                                .attr("name")
                                .substring(0, s.attr("name").length - 2)) +
                          "-" +
                          t) +
                      '">'
                  );
            ...
            n.onRemove != null && typeof n.onRemove == "function"
              ? n.onRemove(el, f._itFl[id].file, id, l, p, o, s)
              : null;
            callback(el, id);
          },

    ...
    plugins: {
      allowTagsFromPaste: {
        init: function (trumbowyg) {
          ...
          trumbowyg.o.plugins.allowTagsFromPaste = trumbowyg.o
            .allowTagsFromPaste
            ? $(defaultOptions.allowTagsFromPaste)
                .not(trumbowyg.o.allowTagsFromPaste)
                .get()
            : [];
          trumbowyg.pasteHandlers.push(function () {
            setTimeout(function () {
              ...
              $.each(
                trumbowyg.o.plugins.allowTagsFromPaste,
                function (iterator, tagName) {
                  processNodes = processNodes.replace(

  ...
  $.extend(true, $.trumbowyg, {
    langs: {
      ...
      en: {
        ...
        file: "File",
        errFileReaderNotSupported:
          "FileReader is not supported by your browser.",
      ...
      da: {
        ...
        file: "Fil",
        errFileReaderNotSupported:
          "FileReader er ikke understøttet af din browser.",
      ...
      nl: {
        ...
        file: "Bestand",
        errFileReaderNotSupported:
          "Uw browser ondersteunt deze functionaliteit niet.",
      ...
      ru: {
        ...
        file: "Файл",
        errFileReaderNotSupported:
          "FileReader не поддерживается вашим браузером.",
      ...
      ja: {
        ...
        file: "ファイル",
        errFileReaderNotSupported:
          "あなたのブラウザーはFileReaderをサポートしていません",
      ...
      tr: {
        ...
        file: "Dosya",
        errFileReaderNotSupported:
          "FileReader tarayıcınız tarafından desteklenmiyor.",

        ...
        init: function (t) {
          ...
          var buildButtonDef = {
            fn: function () {
              ...
              if (
                t.$box.find("." + dropdownPrefix + "-" + btnName).length === 0
              ) {
              ...
              if (
                t.$box
                  .find("." + t.o.prefix + "table-button")
                  .hasClass(t.o.prefix + "active-button")
              ) {
          ...
          var tableAnimate = function (column_event) {
            ...
            for (var i = 0; i <= rowIndex; i += 1) {
              for (var j = 0; j <= colIndex; j += 1) {
                table
                  .find("tr:nth-of-type(" + (i + 1) + ")")
                  .find("td:nth-of-type(" + (j + 1) + ")")
                  .addClass("active");
              }
            }
          ...
          var addRow = {
            ...
            fn: function () {
              ...
              if (table.length > 0) {
                ...
                for (
                  var i = 0;
                  i < table.find("tr")[0].childElementCount;
                  i += 1
                ) {
                  $("<td></td>").appendTo(row);
                }

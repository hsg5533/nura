  ...
  (function (e, t, n, a) {
    ...
    i.prototype = {
        ...
        e.$ed
          ...
          .on("focus blur", function (t) {
            if (
              ...
              "blur" === t.type &&
                a("." + n + "active-button", e.$btnPane).removeClass(
                  n + "active-button " + n + "active"
                ),
              e.o.autogrowOnEnter)
            ) {
          ...
          e.$box.on("keydown", function (t) {
            if (27 === t.which && 1 === a("." + n + "modal-box", e.$box).length)
              ...
              if (o) {
                ...
                r - i > 0 && r - i - e.height < 0
                  ? (e.isFixed ||
                      ...
                      a([e.$ta, e.$ed]).css({ marginTop: s.height() })),
                    s.css({ width: n ? "100%" : o.width() - 1 + "px" }),
      ...
      openModal: function (e, n) {
        ...
        i.o.autogrowOnEnter && (i.autogrowOnEnterDontClose = !0),
          i.saveRange(),
          i.showOverlay(),
          i.$btnPane.addClass(s + "disable");
        var l = a("<div/>", { class: s + "modal " + s + "fixed-top" })
          .css({
        ...
        var d = a("<form/>", { action: "", html: n })
          ...
          c = a("<div/>", { class: s + "modal-box", html: d })
            .css({ top: "-" + i.$btnPane.outerHeight() + "px", opacity: 0 })
            .appendTo(l)
            .animate({ top: 0, opacity: 1 }, 100);
        return (
          a("<span/>", { text: e, class: s + "modal-title" }).prependTo(c),
          l.height(c.outerHeight() + 10),
          a("input:first", c).focus(),
          i.buildModalBtn("submit", c),
          i.buildModalBtn("reset", c),
          a(t).trigger("scroll"),
          l
        );
      },
      ...
      addErrorOnModalField: function (e, t) {
        ...
        e.on("change keyup", function () {
          ...
          o
            ...
            .find("input+span")
            .append(a("<span/>", { class: n + "msg-error", text: t }));
      },

...
!(function (a) {
  ...
  (function (a) {
    (window.ParsleyExtend = window.ParsleyExtend || {}),
      (window.ParsleyExtend = a.extend(!0, window.ParsleyExtend, {
        asyncSupport: !0,
        asyncValidators: {
          default: {
            fn: function (a) {
        ...
        addAsyncValidator: function (a, b, c, d) {
          return (
            (this.asyncValidators[a.toLowerCase()] = {
              fn: b,
              url: c || !1,
              options: d || {},
            }),
        ...
        onSubmitValidate: function (b) {
          ...
          if (!0 !== b.parsley)
            return (
              (this.submitEvent = a.extend(!0, {}, b)),
              b instanceof a.Event &&
                (b.stopImmediatePropagation(), b.preventDefault()),
              this._asyncValidateForm(void 0, b).done(function () {
                c._trigger("submit") &&
                  !c.submitEvent.isDefaultPrevented() &&
                  c.$element.trigger(
                    a.extend(a.Event("submit"), { parsley: !0 })
                  );
              })
            );
        },
        ...
        _asyncValidateForm: function (b) {
          ...
          for (var e = 0; e < this.fields.length; e++)
            (b && b !== this.fields[e].options.group) ||
              d.push(this.fields[e]._asyncValidateField());
          return a.when
            .apply(a, d)
            .done(function () {
              c._trigger("success");
        ...
        _asyncIsValidForm: function (b, c) {
          ...
          for (var e = 0; e < this.fields.length; e++)
            (b && b !== this.fields[e].options.group) ||
              d.push(this.fields[e]._asyncIsValidField(c));
        ...
        _asyncIsValidField: function (b, c) {
          ...
          return (
            !1 === this.isValid(b, c)
              ? d.rejectWith(this)
              : "undefined" != typeof this.constraintsByName.remote
              ? this._remote(d)
              : d.resolveWith(this),
            d.promise()
          );
        ...
        _remote: function (b) {
          ...
          if (
            ((g = g.toLowerCase()),
            "undefined" == typeof this.asyncValidators[g])
          )
            throw new Error(
              "Calling an undefined async validator: `" + g + "`"
            );
          (f[this.$element.attr("name") || this.$element.attr("id")] =
            this.getValue()),
            (this.options.remoteOptions = a.extend(
              !0,
              this.options.remoteOptions || {},
              this.asyncValidators[g].options
            )),
            (c = a.extend(
              !0,
              {},
        ...
        _handleRemoteResult: function (a, b, c) {
          return "function" == typeof this.asyncValidators[a].fn &&
            this.asyncValidators[a].fn.call(this, b)
            ? void c.resolveWith(this)
            : ((this.validationResult = [

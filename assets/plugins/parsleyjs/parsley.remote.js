  ...
  var Validator = (function () {
        ...
        for (var property in this.nodes) {
          ...
          try {
            if (
              !this.has(
                property,
                this.options.strict || isRequired ? object : undefined
              )
            ) {
    ...
    Assert.prototype = {
      ...
      Collection: function (assertOrConstraint) {
        ...
        this.constraint =
          "undefined" !== typeof assertOrConstraint
            ? assertOrConstraint instanceof Assert
              ? assertOrConstraint
              : new Constraint(assertOrConstraint)
            : false;
